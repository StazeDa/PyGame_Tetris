...
pygame.mixer.music.load('data/Parts/sound_start.mp3')
...
main_font = pygame.font.Font('data/Parts/font.ttf', 65)
font = pygame.font.Font('data/Parts/font.ttf', 45)
...
def load_image(name, colorkey=None):
    fullname = os.path.join('data/Parts', name)
